...
Route::get('cust_report', [ReportController::class,'customerReport']);
Route::get('catagory_report', [ReportController::class,'categoryReport']);
Route::get('product_report', [ReportController::class,'productReport']);
// use App\Http\Controllers\CustomerController;
